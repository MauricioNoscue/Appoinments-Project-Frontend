...
@Component({
  selector: 'app-request-doctor-details',
  standalone:false,
  templateUrl: './request-doctor-details.component.html',
  styleUrl: './request-doctor-details.component.css'
})
export class RequestDoctorDetailsComponent implements OnInit {
